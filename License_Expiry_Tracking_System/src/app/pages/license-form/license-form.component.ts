      ...
      <div class="form-container">
        ...
        <form [formGroup]="licenseForm" (ngSubmit)="onSubmit()" class="form-content">
          <div class="form-group">
            <label>Name</label>
            <input formControlName="name" class="form-control" placeholder="e.g. name">
          </div>
          <div class="form-group">
            <label>License Key <span class="badge-optional" *ngIf="false">Optional</span></label>
            <input formControlName="key" class="form-control font-mono" placeholder="">
          </div>
          <div class="form-grid">
            <div class="form-group">
              <label>Provider</label>
              <input formControlName="provider" class="form-control" placeholder="">
            </div>
            <div class="form-group">
